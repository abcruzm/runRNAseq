...
[![GitHub
issues](https://img.shields.io/github/issues/abcruzm/runRNAseq)](https://github.com/abcruzm/runRNAseq/issues)
[![GitHub
pulls](https://img.shields.io/github/issues-pr/abcruzm/runRNAseq)](https://github.com/abcruzm/runRNAseq/pulls)
[![Lifecycle:
...
[![R-CMD-check-bioc](https://github.com/abcruzm/runRNAseq/actions/workflows/R-CMD-check-bioc.yaml/badge.svg)](https://github.com/abcruzm/runRNAseq/actions/workflows/R-CMD-check-bioc.yaml)
[![Codecov test
coverage](https://codecov.io/gh/abcruzm/runRNAseq/graph/badge.svg)](https://app.codecov.io/gh/abcruzm/runRNAseq)
<!-- badges: end -->
...
[GitHub](https://github.com/abcruzm/runRNAseq) with:

``` r
BiocManager::install("abcruzm/runRNAseq")
```
...
#> 
#>   abcruzm (2024). _runRNAseq_. doi:10.18129/B9.bioc.runRNAseq
#>   <https://doi.org/10.18129/B9.bioc.runRNAseq>,
#>   https://github.com/abcruzm/runRNAseq/runRNAseq - R package version
...
#>     note = {https://github.com/abcruzm/runRNAseq/runRNAseq - R package version 0.99.0},
#>     doi = {10.18129/B9.bioc.runRNAseq},
#>   }
#> 
#>   abcruzm (2024). "runRNAseq." _bioRxiv_. doi:10.1101/TODO
...
- The [documentation website](http://abcruzm.github.io/runRNAseq) is
